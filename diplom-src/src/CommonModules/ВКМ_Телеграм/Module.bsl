...
Процедура ОтправитьСообщение() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               |	ВКМ_ИдентификаторГруппыДляОповещенияТГ.Значение КАК Chat_ID,
	               ...
	               |	Константа.ВКМ_ИдентификаторГруппыДляОповещенияТГ КАК ВКМ_ИдентификаторГруппыДляОповещенияТГ,
